...
if (isset($_SESSION['valida_sessao'])) {
    ...
    <html lang="pt-br">
        ...
        <body>
            ...
            <h2 align="center"> Boletim do aluno </h2>
            <div class="container">
                
                <form id="frmCadastro">
                    <table>
                        <tr>
                            <td> <label for="txtCodigo">Matéria: </label> <input type="text" id="txtCodigo"> </td>
                            <td> <label for="txtNome">Nota G1:</label>    <input type="text" id="txtNome"> </td>
                            <td> <label for="txtTelefone">Nota G2:</label><input type="text" id="txtTelefone"> </td>
                            <td> <label for="txtEmail">Média:</label>     <input type="text" id="txtEmail"> </td>
                            <td> <input type="submit" value="Salvar" id="btnSalvar"/></td>
                        </tr>                        
                    </table>                    
                </form>
