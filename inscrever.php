    ...
    <center>  <div class="container" >
            ...
            <div class="col-md-4">
                ...
                <form method="post" action="cadastro.php" >
                    ...
                    <div class="form-group coll-md-4">
                        ...
                        <button type="submit" name="submit" value="submit"class="btn btn-success form-control" >Inscreva-se</button>
        ...
        <div class="container">
            <div class="coll-md-4">
                ...
                <br/>
                <a href="login.php"><button class="btn btn-success " type="button" data-toggle="dropdown">Entrar</button></a>
                <br />
